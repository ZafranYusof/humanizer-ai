...
HF.getOutputText = function() { var o = HF.getOutput(); return o ? o.value : ''; };
...
HF.getInputText = function() {
  var el = document.querySelector('#inputText') || document.querySelector('textarea');
  return el ? el.value : '';
};
...
HF.initStrengthSlider = function() {
  ...
  var ta = document.querySelector('#inputText') || document.querySelector('textarea');
